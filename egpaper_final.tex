...
\textbf{Datasets} We use the MNLI dataset for generating the context data. For In-domain generalization, we mesaure the accuracy on the validation set of MNLI dataset. For out-of domain generalization, we choose the lexical overlap subset of HANS. The MNLI dataset is binarized by removing the neutral samples.\\\\
